...
void EscCastle::begin()
{
    ...
    // FTM1: CAPTURE RX PULSE (PIN: CH0 -> PTB0 -> 16/A2)
    FTM1_IRQ_handlerP = FTM1_IRQ_handler;
    FTM1_SC = 0;
    FTM1_CNT = 0;
    FTM1_CNTIN = 0;
    ...
    FTM1_SC = FTM_SC_PS(6) | FTM_SC_CLKS(1) /*| FTM_SC_TOIE*/; // PRESCALER 64 | ENABLE COUNTER | ENABLE OVERFLOW INTERRUPT
    // CH0: INPUT CAPTURE
    ...
    FTM0_SC = 0;
    FTM0_CNT = 0;
    FTM0_MOD = 20 * MS_TO_COMP(64);          // 20ms (100HZ)
    ...
    // CH2: TOGGLE CH0 TO OUTPUT
    //FTM0_C2SC = FTM_CSC_MSA;        // SOFTWARE COMPARE
    //FTM0_C2V = 12 * MS_TO_COMP(64); // 12ms TOGGLE CH0 TO OUTPUT
    // SET PINS
    //PORTD_PCR0 = PORT_PCR_MUX(0); // PTD0 MUX 0 -> DISABLE
    PORTC_PCR1 = PORT_PCR_MUX(4); // FTM0_CH0 MUX 4 -> PTC1 -> 22/A8(PWM OUT)
